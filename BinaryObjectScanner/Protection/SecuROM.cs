...
namespace BinaryObjectScanner.Protection
{
    ...
    public class SecuROM : IExecutableCheck<PortableExecutable>/*, IPathCheck*/
    {
        ...
        private static readonly Dictionary<string, string> In80 = new()
        {
            ...
            {"2521fcb8cfa446e63788978050687b", "Grand Theft Auto IV"}, // Has a prefixed zero in 80_PA, but that's confirmed to be wrong and manually changed back here. TODO: should probably change back the others
